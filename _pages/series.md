...
2. **바쁘신 분**: 1~3회(원리)로 개념만 잡고, 곧바로 8~9회(실습)로 건너뛰어도 됩니다. 다만 7회의 Colab 준비는 실습 전에 꼭 보셔야 합니다
...
### 1회 — [예전에는 말귀를 못 알아듣던 신입(AI)이, 언제부터 똑똑한 에이스가 되었나?](/posts/genai-data-analysis-for-beginners-1/)

*규칙만 따르던 AI가 스스로 일하게 되기까지*

인공지능은 어떻게 시킨 일만 겨우 하던 신입에서, 시키지 않은 일까지 알아서 해내는 에이스가 되었을까요? 규칙 기반 AI, 머신러닝, 딥러닝, 생성형 AI로 이어지는 발전 과정을 회사 생활에 비유해 풀어봅니다.

### 2회 — [이 에이스, 사실은 '초강력 자동완성기'였습니다](/posts/genai-data-analysis-for-beginners-2/)
...
### 3회 — [에이스 말, 다 믿으면 큰일 납니다](/posts/genai-data-analysis-for-beginners-3/)

*환각과 인지부채 — AI를 쓸수록 똑똑해질까, 게을러질까*

생성형 AI는 확률이 높은 답을 자신 있게 내놓을 뿐, 사실 여부를 검증하지 않습니다. 왜 반드시 사람이 검토해야 하는지, 환각과 인지부채라는 두 가지 위험을 짚어봅니다.

### 4회 — [물어보는 AI, 옆에서 거드는 AI, 통째로 맡기는 AI](/posts/genai-data-analysis-for-beginners-4/)

*대화형·코파일럿·에이전트, 그리고 SK하이닉스·삼성전자의 실제 활용 사례*

생성형 AI를 쓰는 방식은 크게 세 가지입니다. 물어보고 답을 받는 대화형, 작업 중인 화면 안에서 거들어주는 코파일럿, 목표만 주면 알아서 여러 단계를 수행하는 에이전트. ChatGPT·Gemini·Claude·Perplexity 비교와 기업 활용 사례까지 정리합니다.

### 5회 — [에이스에게 일 맡길 때, 이 9가지는 빠뜨리지 마세요](/posts/genai-data-analysis-for-beginners-5/)

*좋은 프롬프트를 구성하는 9가지 요소*

좋은 프롬프트는 문장을 길게 쓰는 게 아니라, 필요한 요소를 빠뜨리지 않는 것입니다. 지시부터 역할까지, 프롬프트를 구성하는 9가지 요소와 각각의 좋은 예·나쁜 예를 정리했습니다.
...
### 7회 — [데이터 분석은 요리와 똑같습니다](/posts/genai-data-analysis-for-beginners-7/)

*Python·Colab 첫걸음, 코드 몰라도 괜찮습니다*

Python 문법을 몰라도 됩니다. 이번 실습에 필요한 최소한의 도구, Google Colab 사용법과 데이터프레임의 기본 개념만 요리 레시피 보듯 쉽게 정리했습니다.

### 8회 — [이제 진짜로 해봅시다 — 고객 이탈 데이터 분석 실습](/posts/genai-data-analysis-for-beginners-8/)
...
### 9회 — [반도체 품질 데이터로, 보고서까지 자동으로 완성해봅시다](/posts/genai-data-analysis-for-beginners-9/)
