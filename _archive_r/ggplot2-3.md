...
tags:
  ...
  - 시각화
  - R
excerpt: "이번 포스팅에서는 지도를 활용하는 몇 가지 방법에 대해 소개해드릴까 합니다. 사실 해보고 나면 크게 어렵지 않은데 해보기 전에는 상당히 까다로울 것 같은 느낌을 …"
---
...
![](/assets/images/ggplot2-3/ggplot2-3-01.png)

가장 아래에 있는 **키 가져오기** 버튼을 클릭합니다. 그러면 아래와 같이 화면 중앙에 팝업 이미지가 하나 생성됩니다.

![](/assets/images/ggplot2-3/ggplot2-3-02.png)
...
![](/assets/images/ggplot2-3/ggplot2-3-06.png)
...
![](/assets/images/ggplot2-3/ggplot2-3-07.png)
...
![](/assets/images/ggplot2-3/ggplot2-3-10.png)
...
![](/assets/images/ggplot2-3/ggplot2-3-11.png)
...
![](/assets/images/ggplot2-3/ggplot2-3-12.png)
