---
title: "말귀를 못 알아듣던 신입(규칙 기반 AI)이, 어떻게 에이스(생성형 AI)가 되었을까?"
...
tags:
  ...
  - 머신러닝
  - 딥러닝
excerpt: "신입은 시킨 일만 겨우 해냈지만, 에이스는 시키지 않은 일까지 알아서 처리합니다. 규칙 기반 AI에서 머신러닝, 딥러닝을 거쳐 생성형 AI에 이르는 인공지능의 발전 과정을 회사 생활에 비유해 풀어봅니다."
sidebar:
  nav: "genai"
---

이 글은 「생성형 AI로 시작하는 데이터 분석」 9회 연재 중 **1회**입니다. [전체 목차 보기](/genai-series/)
{: .notice--info}
