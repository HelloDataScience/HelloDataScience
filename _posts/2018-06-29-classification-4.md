...
tags:
  - 분류모형
  - 랜덤포레스트
excerpt: "이번 포스팅은 분류모형 네 번째 소개로 로지스틱 회귀분석입니다. 로지스틱 회귀분석은 범주형인 목표변수를 입력변수들의 선형결합으로 표현한 것입니다. 로지스틱 회귀모…"
---
...
![](/assets/images/classification-4/classification-4-01.png)
...
![](/assets/images/classification-4/classification-4-02.png)
...
![](/assets/images/classification-4/classification-4-03.png)
